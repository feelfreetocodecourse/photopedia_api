...
function getSaleSummary() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, models_1.OrderModel.aggregate()
                        .match({
                        orderStatus: "Success",
                    })
                        .group({
                ...
                case 1:
                    summary = _a.sent();
                    return [2 /*return*/, summary.map(function (e) {
                            var picture = e.picture[0];
...
function summary(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var saleSummary, totalUsers, totalOrders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getSaleSummary()];
                case 1:
                    saleSummary = _a.sent();
